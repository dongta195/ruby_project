...
Devise.setup do |config|
  ...
  config.secret_key = ENV["TERMINAL_SECRET_KEY_BASE="]
  ...
  # using other algorithms, it sets how many times you want the password
  # to be hashed.
  #
  ...
  # config.pepper = '2d11a018b4bcbfec201d4752bbd9cdf3f2ffdb3e192bd991d933bf7aa93
  # ffc8c92d495242a68656be6dcb551c381fce124c271169ed43d70d0b419a82d67bf9a'
